...
COURSERA_TOKEN = "cU3wyUYi79Z0c0co"# the key provided to the Student under his/her email on submission page
...
euclidean_distances_vector_l = np.random.uniform( low=lower_boundary, high=upper_boundary, size=(sample_size, n) )



for i in range(0, len(X)):    
    dst = distance.euclidean(X[i],Y[i]);
    euclidean_distances_vector_l[i] = dst,

    
    
print("lenght X",len(X));
print("lenght v",len(euclidean_distances_vector_l));
print("euclidean_distances_vector_l",euclidean_distances_vector_l);
